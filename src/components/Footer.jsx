  ...
  return (
    <footer className="bg-purple-900 dark:bg-purple-900 bottom-0 ">
      <div className="mx-auto w-full max-w-screen-xl">
        <div className="grid grid-cols-2 gap-4 px-4 py-6 lg:py-8 md:grid-cols-4">
          <div className="transition duration-300 transform hover:scale-110">
            ...
            <div className="text-gray-400 transition duration-300 transform hover:scale-110">
              ...
              <p>The First, Shivalik, Vastrapur, Ahmedabad, Gujarat 380015</p>
          ...
          <div className="md:hidden relative transition duration-300 transform hover:scale-110">
            <h2 className="mt-4 mb-2 text-sm font-semibold text-gray-900 uppercase dark:text-white ">
              Connect With Us
            </h2>
              ...
              <div className="flex mt-4 space-x-5 md:mt-0 ">
                ...
                >
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
                    xmlns="http://www.w3.org/2000/svg transition duration-300 transform hover:scale-110"
                    fill="currentColor"
                    viewBox="0 0 8 19"
                  >
                    <path
                ...
                <a
                  href="#"
                  className="text-gray-400 hover:text-gray-900 dark:hover:text-white transition duration-300 transform hover:scale-110"
                >
                  <svg
                    className="w-4 h-4"
                    aria-hidden="true"
          ...
          <div className="hidden md:inline-block relative  transition duration-300 transform hover:scale-110">
            <h2 className=" mb-2 text-sm font-semibold text-gray-900 uppercase dark:text-white ">
              Connect With Us
            </h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
        ...
        <div className="md:hidden relative mt-[-4rem] mb-4 text-center pt-10 sm:pt-12 font-light flex items-center justify-center">
          <div className="text-center pt-10 sm:pt-12 font-light">
