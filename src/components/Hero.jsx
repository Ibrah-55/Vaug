...
Ignite Growth</h1>
        ...
        font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">Contact us now</button>
...
<div className="section-content flex flex-col md:flex-row w-full items-center justify-center gap-8 text-center">
  ...
  <div className="lg:h-auto py-8 px-6 text-gray-600 rounded-3xl border border-gray-200 bg-white">
                  <svg className="w-auto m-auto h-auto" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="mt-6">
                      ...
                      <div className="mt-2 flex justify-center gap-4">
                          ...
                          <div className="flex items-end gap-1 text-green-500">
                              <svg className="w-auto" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                          ...
                          <tr>
                              ...
                              <td>
                                  <svg className="w-16 ml-auto " viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      <rect opacity="0.4" width="17" height="auto" rx="1" fill="#e4e4f2"/>
                                      <rect opacity="0.4" x="19" width="auto" height="auto" rx="1" fill="#e4e4f2"/>
                                      <rect opacity="0.4" x="35" width="auto" height="auto" rx="1" fill="#e4e4f2"/>
                                      <rect opacity="0.4" x="51" width="17" height="auto" rx="1" fill="#e4e4f2"/>
                          ...
                          <tr>
                              ...
                              <td>
                                  <svg className="w-16 ml-auto" viewBox="0 0 68 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                      ...
                                      <rect opacity="0.4" x="19" width="auto" height="auto" rx="1" fill="#e4e4f2"/>
                                      <rect opacity="0.4" x="35" width="auto" height="auto" rx="1" fill="#e4e4f2"/>
                                      <rect opacity="0.4" x="51" width="auto" height="auto" rx="1" fill="#e4e4f2"/>
  ...
  <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[10px] rounded-[2.5rem] h-auto  max-w-auto md:h-auto  md:max-w-auto">
    ...
    <div className="h-auto w-auto bg-gray-800 dark:bg-gray-800 absolute -left-[17px] top-[178px] rounded-l-lg"></div>
    <div className="h-auto w-auto bg-gray-800 dark:bg-gray-800 absolute -right-[17px] top-[142px] rounded-r-lg"></div>
    <div className="rounded-[2rem] overflow-hidden h-auto  md:h-auto bg-white dark:bg-gray-800">
        <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/tablet-mockup-image.png" className="dark:hidden h-auto  md:h-auto" alt="" />
        <img src="https://flowbite.s3.amazonaws.com/docs/device-mockups/tablet-mockup-image-dark.png" className="hidden dark:block h-auto  md:h-auto" alt="" />
    </div>
</div>
  </div>
 ...
 h-auto w-auto shadow-xl transition-transform transform-gpu hover:scale-110">
  ...
  <div className="relative mx-auto border-gray-800 dark:border-gray-800 bg-gray-800 border-[10px] rounded-[2.5rem] h-auto  w-auto shadow-xl">
    <div className="w-auto h-auto bg-gray-800 top-0 rounded-b-[1rem] left-1/2 -translate-x-1/2 absolute"></div>
    <div className="h-auto w-auto bg-gray-800 absolute -left-[17px] top-[124px] rounded-l-lg"></div>
    <div className="h-auto w-auto bg-gray-800 absolute -left-[17px] top-[178px] rounded-l-lg"></div>
    <div className="h-auto w-auto bg-gray-800 absolute -right-[17px] top-[142px] rounded-r-lg"></div>
    <div className="rounded-[2rem] overflow-hidden w-[172px]  h-auto  bg-white dark:bg-gray-800 ">
        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/mockup-2-light.png" className="dark:hidden w-auto h-auto " alt="" />
        <img src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/hero/mockup-2-dark.png" className="hidden dark:block w-auto h-auto " alt="" />
    </div>
</div>
 </div>
