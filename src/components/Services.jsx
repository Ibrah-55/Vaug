    ...
    <div>
        <section className="flex justify-center items-center mx-auto">
            <div className="max-w-4xl px-5 py-24 ">
              ...
              <div className="flex flex-wrap my-10 md:grid-cols-5 md:flex flex-row ">
                  ...
                  <div className="pattern-dots-md gray-light">
                    <div className="rounded-3xl bg-gray-800 p-4 transform translate-x-6 -translate-y-6  "  >
                      ...
                      <div className="flex-grow ">
                        <h2 className=" text-white text-xl title-font font-medium mb-3">Website<br /> Development</h2>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="p-5 md:w-1/3 md:mb-0 mb-6 flex flex-col transform-gpu hover:scale-110  ">
                  <div className="pattern-dots-md gray-light">
                    <div className="rounded-3xl bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                      ...
                      <div className="flex-grow">
                        <h2 className=" text-white text-xl title-font font-medium mb-3">Search Engine Ranking</h2>
                ...
                {/* <div className="p-5 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                  <div className="pattern-dots-md gray-light">
                    <div className="rounded-3xl bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                      ...
                      <div className="flex-grow">
                        <h2 className=" text-white text-xl title-font font-medium mb-3">Email <p>Marketting</p></h2>
                  ...
                  <div className="pattern-dots-md gray-light">
                    <div className="rounded-3xl bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                      ...
                      <div className="flex-grow  text-white">
                        <h2 className=" text-xl title-font font-medium mb-3">Social media Marketing</h2>
