                  ...
                  <div className="pattern-dots-md gray-light">
                    <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6  "  >
                      ...
                      <div className="flex-grow ">
                        <h2 className=" text-white text-xl title-font font-medium mb-3">Webdesign</h2>
                        <p className=" text-white leading-relaxed text-sm text-justify">Donner du goût ? de la couleur aux applications, je le fais afin de rendre vos sites attrayants ?. Avant de devenir webdesigner, depuis tout petit j'étais déjà familier à la couleur et du dessin.</p>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                  <div className="pattern-dots-md gray-light">
                    <div className="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                      ...
                      <div className="flex-grow">
                        <h2 className=" text-white text-xl title-font font-medium mb-3">Intégration web</h2>
